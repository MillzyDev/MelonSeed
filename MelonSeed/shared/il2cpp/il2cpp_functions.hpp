...
#define IL2CPP_FUNC(ret, name, ...)                         \
static ret (*p_##name)__VA_ARGS__;                          \
template<typename... TArgs>                                 \
__declspec(dllexport) ret name(TArgs&&... args) {           \
    if (!p_##name) {                                        \
                                                            \
    }                                                       \
...
namespace melonseed::il2cpp {
    ...
    IL2CPP_FUNC(void, il2cpp_native_stack_trace, (const Il2CppException * ex, uintptr_t** addresses, int* numFrames, char** imageUUID, char** imageName))
    ...
    IL2CPP_FUNC(void*, il2cpp_gc_alloc_fixed, (size_t size))
    IL2CPP_FUNC(void, il2cpp_gc_free_fixed, (void* address))
    ...
    // liveness
    IL2CPP_FUNC(void*, il2cpp_unity_liveness_allocate_struct, (Il2CppClass * filter, int max_object_count, il2cpp_register_object_callback callback, void* userdata, il2cpp_liveness_reallocate_callback reallocate))
    ...
    IL2CPP_FUNC(void, il2cpp_unity_liveness_finalize, (void* state))
    IL2CPP_FUNC(void, il2cpp_unity_liveness_free_struct, (void* state))
